...
class UpdateActivity : AppCompatActivity() {
    ...
    private fun phoneNeedsUpdate(release: UpdateChecker.ReleaseInfo): Boolean =
            release.mobileApkUrl != null && AppVersionComparison.isNewerThanInstalled(release.tag)
    ...
    private fun watchNeedsUpdate(release: UpdateChecker.ReleaseInfo): Boolean {
        ...
        return if (watch != null) {
            AppVersionComparison.isNewer(release.tag, watch)
        } else {
            AppVersionComparison.isNewerThanInstalled(release.tag)
        }
    }
