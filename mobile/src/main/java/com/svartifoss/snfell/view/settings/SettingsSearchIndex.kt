...
object SettingsSearchIndex {
                        ...
                        if (parser.name.endsWith(CATEGORY_TAG_SUFFIX)) {
                            ...
                            categorySection?.let { section ->
                                entries += SettingsSearchEntry(
                                        key = key,
                                        title = title,
                                        summary = parser.attr(context, "summary"),
     ...
     * term matches decides the score: a title hit outranks a category hit, which outranks a summary
     * hit, and matching the start of the title outranks matching its middle.
     *
