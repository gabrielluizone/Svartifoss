...
class TutorialFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // This is a standalone Activity, outside MainActivity's live accent traversal, so every
        // accent-coloured element here needs its own one-shot resolve - the layout's own
        // @color/lyra_accent is the static Lyra default and would stay sage under any other
        // accent. Resolved once and passed down rather than re-read per card: resolve() reads
        // SharedPreferences, and bindCard used to call it twice for each of the twelve cards.
        val accent = LyraAccent.resolve(requireContext())
        view.findViewById<TextView>(R.id.tutorial_tip).setTextColor(accent)
        ...
        bindCard(view, R.id.card_taps, R.drawable.ic_nav_actions,
            R.string.tutorial_taps_title, R.string.tutorial_taps_desc, accent, controlsPath)
        bindCard(view, R.id.card_quick_panel, R.drawable.ic_quick_actions,
            R.string.tutorial_quick_panel_title, R.string.tutorial_quick_panel_desc, accent, actionsPath)
        bindCard(view, R.id.card_gestures, R.drawable.ic_nav_tutorial,
            R.string.tutorial_gestures_title, R.string.tutorial_gestures_desc, accent, controlsPath)
        bindCard(view, R.id.card_buttons, R.drawable.ic_settings,
            R.string.tutorial_buttons_title, R.string.tutorial_buttons_desc, accent, controlsPath)
        bindCard(view, R.id.card_rotary, commonR.drawable.button_turn_cw,
            R.string.tutorial_rotary_title, R.string.tutorial_rotary_desc, accent, behaviorPath)
        bindCard(view, R.id.card_swipe_up, R.drawable.ic_playlist_play,
            R.string.tutorial_swipe_up_title, R.string.tutorial_swipe_up_desc, accent, controlsPath)
        bindCard(view, R.id.card_shortcuts, R.drawable.ic_playlist_add,
            R.string.tutorial_shortcuts_title, R.string.tutorial_shortcuts_desc, accent, actionsPath)
        bindCard(view, R.id.card_yt_music, commonR.drawable.action_liked_songs,
            R.string.tutorial_yt_music_title, R.string.tutorial_yt_music_desc, accent, actionsPath)
        bindCard(view, R.id.card_exit, commonR.drawable.button_back,
            R.string.tutorial_exit_title, R.string.tutorial_exit_desc, accent, behaviorPath)
        bindCard(view, R.id.card_tile, R.drawable.ic_music_note,
            R.string.tutorial_tile_title, R.string.tutorial_tile_desc, accent)
        bindCard(view, R.id.card_complication, R.drawable.ic_music_note,
            R.string.tutorial_complication_title, R.string.tutorial_complication_desc, accent)
        bindCard(view, R.id.card_system, R.drawable.ic_nav_playing,
            R.string.tutorial_system_title, R.string.tutorial_system_desc, accent)
    }
