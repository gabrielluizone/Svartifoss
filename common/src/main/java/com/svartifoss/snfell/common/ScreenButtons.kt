...
/**
 * Pseudo screen-buttons for the row of up to three user-configurable mini buttons shown at a
 * fixed position near the bottom of the watch's now-playing screen (offset tunable via
 * [MiscPreferences.WEAR_SCREEN_BUTTONS_OFFSET]). Like [SwipeGesture], each slot flows
