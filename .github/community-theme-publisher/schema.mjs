...
const DEFAULT_VALUES = Object.freeze({
    ...
    wear_accent_floor_color_mode: "album",
    wear_accent_floor_custom_color: "",
    ...
    wear_metadata_cover_shape: "rounded",
    wear_metadata_show_core: true,
    wear_metadata_show_cover: true,
    ...
    wear_artist_text_bg_color_mode: "black",
    wear_artist_text_bg_custom_color: "",
    wear_artist_text_bg_opacity: 100,
    wear_artist_text_bg_style: "none",
    wear_title_text_bg_color_mode: "black",
    wear_title_text_bg_custom_color: "",
    wear_title_text_bg_opacity: 100,
    wear_title_text_bg_style: "none",
    wear_artist_outline_color_mode: "black",
    wear_artist_outline_custom_color: "",
    wear_artist_outline_style: "none",
    wear_title_outline_color_mode: "black",
    wear_title_outline_custom_color: "",
    wear_title_outline_style: "none",
    wear_artist_shadow_color_mode: "black",
    wear_artist_shadow_custom_color: "",
    wear_artist_shadow_strength: 100,
    wear_artist_shadow_style: "none",
    wear_title_shadow_color_mode: "black",
    wear_title_shadow_custom_color: "",
    wear_title_shadow_strength: 100,
    wear_title_shadow_style: "none",
    wear_seek_layout: "edge",
    wear_seek_marker: "drag",
