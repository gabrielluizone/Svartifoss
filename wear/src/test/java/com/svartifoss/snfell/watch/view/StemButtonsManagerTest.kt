...
import com.svartifoss.snfell.watch.util.SystemClockProvider
...
class StemButtonsManagerTest {
    @Test
    fun testSinglePressWithOthersDisabled() = runTest(UnconfinedTestDispatcher()) {
    ...
    @Test
    fun testSinglePressWithOthersEnabled() = runTest(UnconfinedTestDispatcher()) {
        val listener = TestFunction2()
    ...
    @Test
    fun testSinglePressWithOnlyDoubleEnabled() = runTest(UnconfinedTestDispatcher()) {
        val listener = TestFunction2()
        val buttonsManager = StemButtonsManager(listOf(KeyEvent.KEYCODE_STEM_1), listener, this, TestSystemClock(this), 300, 500)
        buttonsManager.enabledDoublePressActions[KeyEvent.KEYCODE_STEM_1] = true
        buttonsManager.enabledLongPressActions[KeyEvent.KEYCODE_STEM_1] = false
    ...
    @Test
    fun testSinglePressWithOnlyLongEnabled() = runTest(UnconfinedTestDispatcher()) {
        val listener = TestFunction2()
        val buttonsManager = StemButtonsManager(listOf(KeyEvent.KEYCODE_STEM_1), listener, this, TestSystemClock(this), 300, 500)
        buttonsManager.enabledDoublePressActions[KeyEvent.KEYCODE_STEM_1] = false
        buttonsManager.enabledLongPressActions[KeyEvent.KEYCODE_STEM_1] = true
    ...
    @Test
    fun testSinglePressOutOfBounds() = runTest(UnconfinedTestDispatcher()) {
        val listener = TestFunction2()
        val buttonsManager = StemButtonsManager(listOf(KeyEvent.KEYCODE_STEM_1), listener, this, TestSystemClock(this), 300, 500)
        buttonsManager.enabledDoublePressActions[KeyEvent.KEYCODE_STEM_1] = true
        buttonsManager.enabledLongPressActions[KeyEvent.KEYCODE_STEM_1] = true
    ...
    @Test
    fun testRepeatingEvents() = runTest(UnconfinedTestDispatcher()) {
        val listener = TestFunction2()
        val buttonsManager = StemButtonsManager(listOf(KeyEvent.KEYCODE_STEM_1), listener, this, TestSystemClock(this), 300, 500)
        buttonsManager.enabledDoublePressActions[KeyEvent.KEYCODE_STEM_1] = true
        buttonsManager.enabledLongPressActions[KeyEvent.KEYCODE_STEM_1] = false
    ...
    @Test
    fun testSinglePressSecondButton() = runTest(UnconfinedTestDispatcher()) {
        val listener = TestFunction2()
        val buttonsManager = StemButtonsManager(listOf(KeyEvent.KEYCODE_STEM_1, KeyEvent.KEYCODE_STEM_2), listener, this, TestSystemClock(this), 300, 500)
        buttonsManager.enabledDoublePressActions[KeyEvent.KEYCODE_STEM_1] = true
        buttonsManager.enabledLongPressActions[KeyEvent.KEYCODE_STEM_1] = true
    ...
    @Test
    fun testDoublePress() = runTest(UnconfinedTestDispatcher()) {
        val listener = TestFunction2()
        val buttonsManager = StemButtonsManager(listOf(KeyEvent.KEYCODE_STEM_1), listener, this, TestSystemClock(this), 300, 500)
        buttonsManager.enabledDoublePressActions[KeyEvent.KEYCODE_STEM_1] = true
        buttonsManager.enabledLongPressActions[KeyEvent.KEYCODE_STEM_1] = true
    ...
    @Test
    fun testDoublePressWithOnlyItEnabled() = runTest(UnconfinedTestDispatcher()) {
        val listener = TestFunction2()
        val buttonsManager = StemButtonsManager(listOf(KeyEvent.KEYCODE_STEM_1), listener, this, TestSystemClock(this), 300, 500)
        buttonsManager.enabledDoublePressActions[KeyEvent.KEYCODE_STEM_1] = true
        buttonsManager.enabledLongPressActions[KeyEvent.KEYCODE_STEM_1] = false
    ...
    @Test
    fun testDoublePressSecondButton() = runTest(UnconfinedTestDispatcher()) {
        val listener = TestFunction2()
        val buttonsManager = StemButtonsManager(listOf(KeyEvent.KEYCODE_STEM_1, KeyEvent.KEYCODE_STEM_2), listener, this, TestSystemClock(this), 300, 500)
        buttonsManager.enabledDoublePressActions[KeyEvent.KEYCODE_STEM_1] = true
        buttonsManager.enabledLongPressActions[KeyEvent.KEYCODE_STEM_1] = true
     ...
     */
    @Test
    fun testAmbientGlitch() = runTest(UnconfinedTestDispatcher()) {
        val listener = TestFunction2()
        val buttonsManager = StemButtonsManager(listOf(KeyEvent.KEYCODE_STEM_1), listener, this, TestSystemClock(this), 300, 500)
        buttonsManager.enabledDoublePressActions[KeyEvent.KEYCODE_STEM_1] = true
        buttonsManager.enabledLongPressActions[KeyEvent.KEYCODE_STEM_1] = true
    ...
    @Test
    fun testAmbientGlitch2() = runTest(UnconfinedTestDispatcher()) {
        val listener = TestFunction2()
        val buttonsManager = StemButtonsManager(listOf(KeyEvent.KEYCODE_STEM_1), listener, this, TestSystemClock(this), 300, 500)
        buttonsManager.enabledDoublePressActions[KeyEvent.KEYCODE_STEM_1] = true
        buttonsManager.enabledLongPressActions[KeyEvent.KEYCODE_STEM_1] = true
    ...
    @Test
    fun testAmbientGlitch3WithAmbientDoubleClickDisabled() = runTest(UnconfinedTestDispatcher()) {
        val listener = TestFunction2()
        val buttonsManager = StemButtonsManager(listOf(KeyEvent.KEYCODE_STEM_1), listener, this, TestSystemClock(this), 300, 500)
        buttonsManager.enabledDoublePressActions[KeyEvent.KEYCODE_STEM_1] = true
        buttonsManager.enabledLongPressActions[KeyEvent.KEYCODE_STEM_1] = true
    ...
    @Test
    fun testAmbientGlitch4() = runTest(UnconfinedTestDispatcher()) {
        val listener = TestFunction2()
        val buttonsManager = StemButtonsManager(listOf(KeyEvent.KEYCODE_STEM_1), listener, this, TestSystemClock(this), 300, 500)
        buttonsManager.enabledDoublePressActions[KeyEvent.KEYCODE_STEM_1] = true
        buttonsManager.enabledLongPressActions[KeyEvent.KEYCODE_STEM_1] = true
    ...
    @Test
    fun testFastDoublePress() = runTest(UnconfinedTestDispatcher()) {
        val listener = TestFunction2()
        val buttonsManager = StemButtonsManager(listOf(KeyEvent.KEYCODE_STEM_1), listener, this, TestSystemClock(this), 300, 500)
        buttonsManager.enabledDoublePressActions[KeyEvent.KEYCODE_STEM_1] = true
        buttonsManager.enabledLongPressActions[KeyEvent.KEYCODE_STEM_1] = true
    ...
    @Test
    fun testDoublePressFromAmbient() = runTest(UnconfinedTestDispatcher()) {
        val listener = TestFunction2()
        val buttonsManager = StemButtonsManager(listOf(KeyEvent.KEYCODE_STEM_1), listener, this, TestSystemClock(this), 300, 500)
        buttonsManager.enabledDoublePressActions[KeyEvent.KEYCODE_STEM_1] = true
        buttonsManager.enabledLongPressActions[KeyEvent.KEYCODE_STEM_1] = true
    ...
    @Test
    fun testFastDoublePressFromAmbient() = runTest(UnconfinedTestDispatcher()) {
        val listener = TestFunction2()
        val buttonsManager = StemButtonsManager(listOf(KeyEvent.KEYCODE_STEM_1), listener, this, TestSystemClock(this), 300, 500)
        buttonsManager.enabledDoublePressActions[KeyEvent.KEYCODE_STEM_1] = true
        buttonsManager.enabledLongPressActions[KeyEvent.KEYCODE_STEM_1] = true
    ...
    @Test
    fun testDoublePressWhenDisabled() = runTest(UnconfinedTestDispatcher()) {
        val listener = TestFunction2()
        val buttonsManager = StemButtonsManager(listOf(KeyEvent.KEYCODE_STEM_1), listener, this, TestSystemClock(this), 300, 500)
        buttonsManager.enabledDoublePressActions[KeyEvent.KEYCODE_STEM_1] = false
        buttonsManager.enabledLongPressActions[KeyEvent.KEYCODE_STEM_1] = true
    ...
    @Test
    fun testLongPressWithLongPressDisabled() = runTest(UnconfinedTestDispatcher()) {
        val listener = TestFunction2()
        val buttonsManager = StemButtonsManager(listOf(KeyEvent.KEYCODE_STEM_1), listener, this, TestSystemClock(this), 300, 500)
        buttonsManager.enabledDoublePressActions[KeyEvent.KEYCODE_STEM_1] = true
        buttonsManager.enabledLongPressActions[KeyEvent.KEYCODE_STEM_1] = false
    ...
    @Test
    fun testLongPress() = runTest(UnconfinedTestDispatcher()) {
        val listener = TestFunction2()
        val buttonsManager = StemButtonsManager(listOf(KeyEvent.KEYCODE_STEM_1), listener, this, TestSystemClock(this), 300, 500)
        buttonsManager.enabledDoublePressActions[KeyEvent.KEYCODE_STEM_1] = true
        buttonsManager.enabledLongPressActions[KeyEvent.KEYCODE_STEM_1] = true
    ...
    @Test
    fun testLongPressWithOnlyItEnabled() = runTest(UnconfinedTestDispatcher()) {
        val listener = TestFunction2()
        val buttonsManager = StemButtonsManager(listOf(KeyEvent.KEYCODE_STEM_1), listener, this, TestSystemClock(this), 300, 500)
        buttonsManager.enabledDoublePressActions[KeyEvent.KEYCODE_STEM_1] = false
        buttonsManager.enabledLongPressActions[KeyEvent.KEYCODE_STEM_1] = true
    ...
    @Test
    fun testLongPressSecondButton() = runTest(UnconfinedTestDispatcher()) {
        val listener = TestFunction2()
        val buttonsManager = StemButtonsManager(listOf(KeyEvent.KEYCODE_STEM_1, KeyEvent.KEYCODE_STEM_2), listener, this, TestSystemClock(this), 300, 500)
        buttonsManager.enabledDoublePressActions[KeyEvent.KEYCODE_STEM_1] = true
        buttonsManager.enabledLongPressActions[KeyEvent.KEYCODE_STEM_1] = true
...
private class TestSystemClock(private val testScope: TestScope) : SystemClockProvider {
